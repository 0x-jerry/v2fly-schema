// @ts-nocheck
import { V2RayProtocol, IHttpAccountObject, IMTProtoAccount, ShadowSocksMethod, IVLESSAccountObject, IVmessAccount, ITrojanAccountObject } from "./common.ts";
...
export type IV2RayInbound = IV2rayInboundSetting<V2RayProtocol.DOKODEMO_DOOR, IDokodemoInboundSettings> | IV2rayInboundSetting<V2RayProtocol.HTTP, IHttpInboundSettings> | IV2rayInboundSetting<V2RayProtocol.MTPROTO, IMTProtoInboundSettings> | IV2rayInboundSetting<V2RayProtocol.SHADOWSOCKS, IShadowSocksInboundSettings> | IV2rayInboundSetting<V2RayProtocol.SOCKS, ISocksInboundSettings> | IV2rayInboundSetting<V2RayProtocol.VLESS, IVLESSInboundSettings> | IV2rayInboundSetting<V2RayProtocol.VMESS, IVmessInboundSettings> | IV2rayInboundSetting<V2RayProtocol.TROJAN, ITrojanInboundSettings>;