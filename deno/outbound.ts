// @ts-nocheck
import { IHttpAccountObject, ISocksAccountObject, IVmessServerAccountObject, ShadowSocksMethod, V2RayProtocol } from "./common.ts";
import { IV2rayStreamSetting } from "./stream.ts";
...
export type IV2RayOutbound = IV2rayOutboundSetting<V2RayProtocol.BLACKHOLE, IBlackholeOutboundSettings> | IV2rayOutboundSetting<V2RayProtocol.DNS, IDNSOutboundSettings> | IV2rayOutboundSetting<V2RayProtocol.FREEDOM, IFreedomOutboundSettings> | IV2rayOutboundSetting<V2RayProtocol.HTTP, IHttpOutboundSettings> | IV2rayOutboundSetting<V2RayProtocol.MTPROTO, IMTProtoOutboundSettings> | IV2rayOutboundSetting<V2RayProtocol.SHADOWSOCKS, IShadowsocksOutboundSettings> | IV2rayOutboundSetting<V2RayProtocol.SOCKS, ISocksOutboundSettings> | IV2rayOutboundSetting<V2RayProtocol.VMESS, IVmessOutboundSettings> | IV2rayOutboundSetting<V2RayProtocol.VLESS, IVLESSOutboundSettings> | IV2rayOutboundSetting<V2RayProtocol.TROJAN, ITrojanOutboundSettings>;